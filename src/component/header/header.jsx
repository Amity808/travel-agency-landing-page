...
const Header = () => {
  return (
    <div className='header__container flex flex-row mt-4 max-sm:flex-col'>
      <div className='flex justify-start flex-col text-left'>
        ...
        <h1 className='text-black font-bold text-7xl mt-6 mb-8 max-sm:text-3xl'>Travel, enjoy <br /> and live a new <br /> and full life</h1>
        ...
        <img src={play_btn} alt="Play" className=' w-12 h-12 mt-3 max-sm:w-8 max-sm:h-8' />
        <p>Play Demo</p>
        </div>
      </div>
      <div>
